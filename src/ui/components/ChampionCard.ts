...
import type { ChampionSelection } from "../../data/models.js";
...
export function createChampionCard(selection: ChampionSelection, options: ChampionCardOptions = {}): HTMLElement {
...
function createCardTool(text: string, label: string, active: boolean, onClick: () => void): HTMLButtonElement {
