...
export function createResultScreen(result: MatchResult, rewards: RewardResult, onHome: () => void, onReplay: () => void): HTMLElement {
...
function createStatsTable(result: MatchResult): HTMLElement {
