...
export const SPEED_OPTIONS = [1, 3, 5] as const;
...
export function matchLevelXpRequirement(level: number): number {
...
export const ROLE_TO_LANE: Record<Role, "top" | "mid" | "bot"> = {
  top: "top",
  jungle: "mid",
  mid: "mid",
  adc: "bot",
...
export const TIER_ORDER: Tier[] = ["D", "C", "B", "A", "S", "S+"];

export const TIER_UNLOCK_LEVEL: Record<Tier, number> = {
  D: 1,
  C: 10,
  B: 20,
  A: 30,
...
export const PITY_LIMITS: Partial<Record<Tier, number>> = {
  A: 8,
  S: 10,
  "S+": 10
};
