...
export function getChampionTemplate(templateId        )                   {
...
export function getHighestUnlockedTier(accountLevel        )       {
  let unlocked       = "D";
...
export function getRandomChampionOfTier(tier      , rng               = Math.random)                   {
...
export function createOwnedChampion(templateId        , level = 1, uidPrefix = "champ")                {
