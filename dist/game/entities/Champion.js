...
import { calculateAbilityDamage, createCooldowns, getReadyAbility, tickCooldowns,                  } from "../combat/AbilityHandler.js";
                                                                                                                                                                                             
import { UtilityBrain } from "../ai/UtilityBrain.js";
                                                          

const ROLE_ATTACK_RANGE                       = {
  top: 54,
  jungle: 54,
  mid: 96,
  adc: 110,
...
export class Champion extends Entity {
  ...
  // means the champion was hit mid-channel and the recall must break.
          backChannelDamageMark = 0;

  constructor(selection                   , side          , spawn       ) {
